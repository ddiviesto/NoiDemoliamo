      ...
      >
        <div className="flex items-center justify-between gap-3 cursor-pointer select-none" onClick={e => { e.stopPropagation(); onToggle() }}>
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            {daVerificareCount > 0 && (
              <button onClick={e => { e.stopPropagation(); approvaTutti() }} disabled={azione} className="bg-green-600 hover:bg-green-700 text-white rounded-full px-4 py-2 text-xs font-semibold disabled:opacity-50">
                Approva tutti
              </button>
            )}

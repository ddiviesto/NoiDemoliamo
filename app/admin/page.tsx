...
export default function AdminDashboard() {
  ...
  // `fresca`: la pratica appena ricaricata, quando la lista in stato è ancora
  // quella vecchia (es. subito dopo un salvataggio con la matita)
  ...
  async function salvaSez(p: Pratica) {
    ...
    try {
      ...
      aggiornaContatori(p.id, fresche?.find(x => x.id === p.id))
      setSezEdit(null)
    } catch (e) {
...
// ⭐ 27/07: ICONE IDENTICHE al passo "Che veicolo è?" di /inizia — dal
// 28/07 vivono in UN componente condiviso (app/components/IconaVeicolo)
// usato anche dalla home cliente e dalla card "Dati del veicolo".

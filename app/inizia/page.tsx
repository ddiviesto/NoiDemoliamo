            ...
            <div className="mt-4 flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 border-2 border-dashed border-blue-200 rounded-xl bg-blue-50 hover:bg-blue-100 transition-all text-blue-700"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all text-gray-600"
                >

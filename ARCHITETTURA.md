...
- ⭐ **RINOMINE STATI** (Davide): `ritiro_confermato` = "**Ritiro Programmato**" (secco, senza "Assegnata ·"); famiglia ritirata = "**Mezzo Ritirato**": "Mezzo Ritirato · Attesa Certificati" (ritirata e attesa rottamazione), "Mezzo Ritirato · attesa recensione", "Mezzo Ritirato · Attesa PRA". La casella del flusso si chiama ancora "Ritirata".

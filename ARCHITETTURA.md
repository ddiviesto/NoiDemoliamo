...
- 🔜 **PROSSIMA SESSIONE (mobile)**: portare TUTTO il flusso `/inizia` allo stile app a tutto schermo (mockup) + la lista di rifiniture mobile che Davide segnalerà con gli screen. Nota Android: stesso codice per tutti i telefoni, differenze solo nelle finezze dei browser — conferma finale con lo STEP 7 (LambdaTest su Android veri).
